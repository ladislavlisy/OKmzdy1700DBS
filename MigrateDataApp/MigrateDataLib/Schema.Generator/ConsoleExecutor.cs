...
{
    public class ConsoleExecutor : IGeneratorWriter
    {
        public ConsoleExecutor(string appRootFolder, DbsDataConfig appDataConfig)
        {
        ...
        public void WriteInfoLine(string infoText)
        {
            ...
            Console.Out.WriteLine(infoText);
        }
