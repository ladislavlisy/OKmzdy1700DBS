...
{
    class SrcTargetGenerator : BaseSourceGenerator
    {
        public SrcTargetGenerator(IDatabaseSchema schema, DbsDataConfig config, ISrcCodebaseBuilder builder, UInt32 version)
